...
class RatingTestCase(TestCase):
    def create_playlists(self):
        ...
        items = [Playlist(title=f'Tv show {i}') for i in range(self.playlist_count)]
    ...
    def create_users(self):
        ...
        items = [User(username=f'user_{i}') for i in range(self.user_count)]
        #
    ...
    def create_ratings(self):
        ...
        for _ in range(self.rating_count):
